    ...
    <main id="bookingPage">
      ...
      >
        ...
        {formik.errors.resDate && formik.touched.resDate && (
          <span className="errorMs">{formik.errors.resDate}</span>
        )}
        ...
        {formik.errors.resTime && formik.touched.resTime && (
          <span className="errorMs">{formik.errors.resTime}</span>
        )}
        ...
        {formik.errors.guests && formik.touched.guests && (
          <span className="errorMs">{formik.errors.guests}</span>
        )}
        ...
        {formik.errors.occasion && formik.touched.occasion && (
          <span className="errorMs">{formik.errors.occasion}</span>
        )}
        <input
          type="submit"
